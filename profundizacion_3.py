...
print('El alumno estuvo presente en {} instancias de evaluación.'.format(cantidad_notas))
print('El alumno estuvo ausente en {} instancias de evaluación.'.format(cantidad_ausentes))
if promedio >= 90:
    ...
    print('La calificación del alumno es: D')
else:
    print ('La calificación del alumno es: F')