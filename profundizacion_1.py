...
inicio = int(input('Ingrese el valor inicial de la secuencia:\n'))
...
print('La cantidad de números dentro de la secuencia es: {}'.format(contador))
print('La sumatoria de los números dentro de la secuencia es: {}'.format(sumatoria))
print('El promedio de los números dentro de la secuencia es: {}'.format(promedio))
